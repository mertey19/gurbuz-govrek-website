...
export function Hero() {
  return (
    <section id="ana-sayfa" className="relative isolate flex min-h-[760px] items-center overflow-hidden bg-navy pt-28 text-white sm:min-h-[820px] lg:min-h-[850px]">
      <Image
      ...
      />
      <div className="absolute inset-0 bg-[linear-gradient(90deg,rgba(7,26,51,.98)_0%,rgba(7,26,51,.94)_36%,rgba(7,26,51,.48)_68%,rgba(7,26,51,.22)_100%)]" />
      ...
      <Container className="relative z-10 py-16 sm:py-24">
        <div className="max-w-2xl">
          <Reveal>
            <p className="eyebrow text-gold-light">Matematik Öğretmeni · Tercih Uzmanı</p>
          </Reveal>
          <Reveal delay={0.08}>
            <h1 className="mt-6 max-w-[11ch] font-serif text-5xl leading-[1.02] font-semibold text-balance sm:text-6xl lg:text-[5.2rem]">
              Doğru Tercih, <span className="text-gold-light">Güçlü Bir Gelecek</span>
            </h1>
          </Reveal>
          <Reveal delay={0.15}>
            <p className="mt-7 max-w-xl text-base leading-7 text-white/74 sm:text-lg sm:leading-8">
          ...
          <Reveal delay={0.28}>
            <ul className="mt-10 grid gap-3 text-sm text-white/72 sm:grid-cols-3 sm:gap-5">
      ...
      <a href="#guven" className="absolute bottom-7 left-1/2 z-10 hidden -translate-x-1/2 flex-col items-center gap-2 text-[10px] tracking-[0.22em] text-white/45 uppercase transition hover:text-white md:flex">
