    ...
    <section id="basari" className="section-space bg-white">
      <Container>
        ...
        <Reveal className="landscape-tall-banner relative mt-12 aspect-[16/8] min-h-[330px] overflow-hidden rounded-sm bg-navy">
          <Image src="/images/success-stories.webp" alt="Gürbüz Gövrek öğrencilerle çalışma masası etrafında" fill sizes="100vw" className="object-cover object-[62%_center] opacity-[.82]" />
