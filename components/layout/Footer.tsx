      ...
      <Container className="landscape-footer py-16 lg:py-20">
        <div className="grid gap-12 border-b border-white/12 pb-14 md:grid-cols-2 lg:grid-cols-[1.5fr_1fr_1fr_1fr]">
          ...
          <div>
            ...
            <ul className="mt-5 space-y-3 text-sm text-white/65">
              <li><Link href="/denizli-tercih-danismanligi" className="hover:text-white">Denizli Tercih Danışmanlığı</Link></li>
              <li><Link href="/denizli-tercih-danismani" className="hover:text-white">Denizli Tercih Danışmanı</Link></li>
              <li><Link href="/denizli-yks-tercih-danismanligi" className="hover:text-white">YKS Tercih Danışmanlığı</Link></li>
