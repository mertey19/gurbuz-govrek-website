...
const PANELS = [
  ...
  {
    href: "/kontenjan-yonetimi",
    title: "Kontenjan Analizleri",
    description: "Yıllara ve puan türlerine göre kontenjan karşılaştırma görselleri yayımlayın.",
    destination: "Ana sayfa · YKS İstatistikleri ve Kontenjan Analizleri",
    icon: ChartNoAxesCombined,
    isNew: true,
  },
  {
    href: "/meslek-slaytlari-yonetimi",
    title: "Meslek Slaytları",
    description: "Karşılaştırmalı meslek ve kariyer slayt serilerini ekleyip sıralayın.",
    destination: "Ana sayfa · Meslek Slaytları",
    icon: Presentation,
    isNew: true,
  },
  {
    href: "/duyuru-yonetimi",
    title: "Flaş Duyuru",
    description: "Ana sayfadaki duyuru şeridini güncelleyin veya geçici olarak kapatın.",
    destination: "Ana sayfa · Açılış bölümünün hemen altı",
    icon: BellRing,
    isNew: true,
  },
  {
    href: "/etkinlik-yonetimi",
    title: "Etkinlik ve Seminerler",
    description: "Etkinlik bölümünün başlıklarını ve gösterilen etkinlik türlerini yönetin.",
  ...
  },
  {
    ...
    description: "Ziyaretçi sorularını ve yanıtlarını ekleyin, sıralayın veya güncelleyin.",
    destination: "Ana sayfa · Sık Sorulan Sorular",
    icon: CircleHelp,
    isNew: true,
  },
  {
    href: "/rapor-yonetimi",
    title: "Rapor ve Kılavuzlar",
    description: "Yeni belge bağlantıları ekleyip açıklayıcı rapor tanıtım sayfaları oluşturun.",
    destination: "Raporlar ve Kılavuzlar",
    icon: Files,
    isNew: true,
  },
] as const;
